...
// mongoose.connect('mongodb://0.0.0.0:27017/NGOProjDB', {
//     useNewUrlParser: true,
//     useUnifiedTopology: true
// });

mongoose.connect(
  "mongodb+srv://rhea:Finn_Wolfhard@cluster0.xyagt.mongodb.net/projectDB"
);
...
app.post("/admin", function (req, res) {
  if (req.body.username === "rhea" && req.body.password === "Finn_Wolfhard") {
    res.render("check");
  } else {
